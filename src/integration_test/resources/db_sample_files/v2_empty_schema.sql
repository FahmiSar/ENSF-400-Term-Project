;             
CREATE USER IF NOT EXISTS SA PASSWORD '8a3855f1eb198976108dae4d0d5cdf5eb907e73321db99c043737af0124852f6' ADMIN;
...
CREATE CACHED TABLE LIBRARY.BORROWER(
    ID INT DEFAULT NEXT VALUE FOR LIBRARY.SYSTEM_SEQUENCE_5EFEED8B_6D6F_4F38_B7F2_220445FE4B5B NOT NULL,
...
CREATE CACHED TABLE LIBRARY.BOOK(
    ID INT DEFAULT NEXT VALUE FOR LIBRARY.SYSTEM_SEQUENCE_77FCB39D_27DD_4D20_81B0_DB61CDF1A6B0 NOT NULL,
...
CREATE CACHED TABLE LIBRARY.LOAN(
    ID INT DEFAULT NEXT VALUE FOR LIBRARY.SYSTEM_SEQUENCE_4DC22436_9D2A_4365_80D1_96EAA7B0932E NOT NULL,
    BOOK INT NOT NULL,
...
CREATE CACHED TABLE AUTH."USER"(
    ID INT DEFAULT NEXT VALUE FOR AUTH.SYSTEM_SEQUENCE_EBB7E93A_A8A2_4BE4_9D42_F602FF467722 NOT NULL,
    NAME VARCHAR(100) NOT NULL,
